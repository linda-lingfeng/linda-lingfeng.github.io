  ...
  return <PortraitExhibit
    ...
    contentList={[
      ...
      {contentType:"text",  content: [
        ...
        {textContentType: "raw", textContent: " to read through and classify ~40 papers based on the type of grading implemented in the study, the target audience and the metric used to evaluate results. This project served to outline current patterns in computer science education research and highlight potential areas for future. Thank you to Professor Brian Harrington for the advice and support provided throughout the project!"},
      ]},
